...
def replace_extra_words(message: str):
    ...
    words_to_replace = (
        ...
        'впереди', 'после', 'а', 'вдобавок', 'именно', 'также', 'то', 'тому', 'благо', 'буде',
        'будто', 'результате', 'чего', 'того', 'связи', 'тем', 'силу', 'случае', 'если', 'время', 'как',
        'том', 'ввиду', 'вопреки', 'вроде', 'вследствие', 'да', 'еще', 'и', 'но', 'дабы', 'даже','даром',
        'чтобы', 'же', 'едва', 'лишь', 'ежели', 'бы', 'не', 'затем', 'зато', 'зачем', 'все', 'значит',
        'поэтому', 'притом', 'всетаки', 'следовательно', 'тогда', 'ибо', 'изза', 'или', 'кабы', 'скоро',
        'словно', 'только', 'так', 'что', 'както', 'когда', 'коли', 'кроме', 'ли', 'либо', 'между', 'нежели',
        'столько', 'сколько', 'только.', 'невзирая', 'независимо', 'несмотря', 'ни', 'однако','особенно',
        'оттого', 'отчего', 'мере', 'причине', 'подобно', 'покамест', 'покуда', 'поскольку', 'потому',
        'почему', 'прежде', 'чем', 'всем', 'условии', 'причем', 'пускай', 'пусть', 'ради', 'раз','раньше',
        'тех', 'пор', 'более', 'есть', 'тоже', 'чуть', 'точно', 'хотя', 'чтоб', 'ох', 'ой', 'пли', 'ух', 'фу',
        'фи', 'ага', 'ах', 'тото', 'эка', 'шш', 'вотвот', 'др', 'ты', 'вы', 'он', 'эх', 'ай', 'эй', 'эти',
        'эк', 'его', 'я', 'она', 'оно', 'мы', 'они', 'себя', 'мой', 'твой', 'свой', 'ваш', 'наш', 'её',
        'их', 'какой', 'чей', 'где', 'который', 'откуда', 'каковой', 'каков', 'тот', 'этот', 'такой',
        'таков', 'сей', 'всякий', 'каждый', 'сам', 'самый', 'любой', 'иной', 'другой', 'весь', ' никто',
        'ничто', 'никакой', 'ничей', 'некого', 'нечего', 'незачем', 'некто', 'нечто', 'некоторый',
        'несколько', 'нибудь')
